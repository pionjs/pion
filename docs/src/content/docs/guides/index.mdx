...
<CardGrid>
  ...
  <Card title="Styling" icon="pencil" href="/guides/styling/">
    Style components with adopted style sheets, css helpers, and CSS modules.
  </Card>
  <Card title="Attributes" icon="setting" href="/guides/attributes/">
    React to attribute changes on your custom elements.
  </Card>
  <Card title="Properties" icon="pen" href="/guides/properties/">
    Manage reactive properties with type-safe accessors.
  </Card>
  <Card title="API" icon="document" href="/guides/api/">
    Explore the full pion API reference.
  </Card>
  <Card title="Dispatching Events" icon="link" href="/guides/events/">
    Emit and listen to custom DOM events from hooks.
  </Card>
  <Card title="Virtual Components" icon="random" href="/guides/virtual/">
    Compose lightweight components without custom element registration.
  </Card>
  <Card title="TypeScript" icon="forward-slash" href="/guides/typescript/">
